...
contract TestERC20 is Test {
    ...
    // Address which holds >9M DAI on Polygon Mainnet
    address public richDAI = 0x27F8D03b3a2196956ED754baDc28D73be8830A6e;
    address public richMATIC = 0x57571d366a00B3389b0aDf30A114BC7DA7a11580;
    ...
    function setUp() public {
        polygonMainnet = vm.createFork("https://polygon.llamarpc.com");
        vm.selectFork(polygonMainnet);
        ...
        vm.startPrank(richMATIC);
        IERC20(matic).transfer(entryPointAdr,5*10**18);
        IERC20(matic).transfer(ecdsaOwnershipModuleAddress,5*10**18);
        IERC20(matic).transfer(smartAccountFactoryAddress,5*10**18);
        IERC20(matic).transfer(smartContractOwnershipModuleAddress,5*10**18);
        vm.stopPrank();
    ...
    function testSADeploymentWithECDSAAuth() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas required in deploying Smart-Account-Wallet with ECDSA Auth Module is : ");
    ...
    function testERC20ColdTransfer() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI transfer (cold access) is :");
    ...
    function testERC20WarmTransfer() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI transfer (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20ColdApprove() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI Approval (cold access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20WarmApprove() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI Approval (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20MintMockCold() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in minting ERC20 (cold mint) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20MintMockWarm() public {
        ...
        console.log("Polygon Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in minting ERC20 (warm mint) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
