...
contract TestERC721 is Test {
    ...
    function testERC721TransferCold() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in NFT transfer (cold access) is :");
    ...
    function testERC721TransferWarm() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in NFT transfer (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC721MintCold() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in minting NFT (cold access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC721MintWarm() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in minting NFT (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC721ApproveWarm() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in approving NFT (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC721ApproveCold() public {
        ...
        console.log("Polygon POS :: ECDSA Module(w/o paymaster) :: Gas consumed in approving NFT (cold access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
