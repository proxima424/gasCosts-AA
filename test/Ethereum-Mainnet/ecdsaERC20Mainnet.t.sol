...
contract TestERC20 is Test {
    ...
    function testSADeploymentWithECDSAAuth() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas required in deploying Smart-Account-Wallet with ECDSA Auth Module is : ");
    ...
    function testERC20ColdTransfer() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI transfer (cold access) is :");
    ...
    function testERC20WarmTransfer() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI transfer (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20ColdApprove() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI Approval (cold access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20WarmApprove() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in DAI Approval (warm access) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20MintMockCold() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in minting ERC20 (cold mint) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
    ...
    function testERC20MintMockWarm() public {
        ...
        console.log("Ethereum Mainnet :: ECDSA Module(w/o paymaster) :: Gas consumed in minting ERC20 (warm mint) is :");
        // Send the userOp to EntryPoint
        uint256 prevGas = gasleft();
        IEntryPoint(entryPointAdr).handleOps(ops, payable(alice));
        console.log(prevGas - gasleft());
